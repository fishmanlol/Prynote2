...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let bundle = R.hostingBundle
      let name = "Main"
      let placeholdeR = StoryboardViewControllerResource<UIKit.UIViewController>(identifier: "PLACEHOLDER")

      func placeholdeR(_: Void = ()) -> UIKit.UIViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: placeholdeR)
      }

      static func validate() throws {
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
        if _R.storyboard.main().placeholdeR() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'placeholdeR' could not be loaded from storyboard 'Main' as 'UIKit.UIViewController'.") }
      }
